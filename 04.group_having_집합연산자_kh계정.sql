/*
    <GROUP BY절>
    그룹기준을 제시할 수 있는 구문(해당 구문기준별 여러 그룹으로 묶을 수 있음)
...
FROM EMPLOYEE
GROUP BY JOB_CODE
ORDER BY 1;     -- 컬럼의 순번을 넣어서 정렬할 수 있음
...
------------------------------- 실습문제 -----------------------------------
-- 1. 직급별 급여합(단, 직급별 급여합이 1000만원 이상인 직급만 조회)직급코드, 급여합 조회
...
-- AND, OR이 더 간단하기 때문에 UNION, INTERSECT는 잘 안씀
